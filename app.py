...
def etl(source='web'):
    ...
    # Standard naming conventions for countries
...
available_countries = data['Country/Region'].unique()
...
region_options = {'Worldwide': available_countries, 'United States': states} 
...
app.layout = html.Div(style={'backgroundColor': colors['background']}, children=[
    ...
    html.H1(children='COVID-19 Data Analysis',
        style={
            'textAlign': 'center',
            'color': colors['text']
            }
    ...
    html.Div(children=[html.H3('Select your region')], style={
        'textAlign': 'center',
        'color': colors['text']
        }),
    ...
    html.Div(
        dcc.Markdown('''
            ...
            Developed By: [Goutham Uppalapati](https://github.com/GouthamU) *Graphs depend on the recent updates in the the data source
            '''),
            style={
                'textAlign': 'center',
                'color': '#111111',
